...
export default function Product({
    ...
    async function addToCart(productId) {
        ...
        axios.put(`${"http://localhost:5000"}/user/${user._id}/cart`, itemDetails, { withCredentials: true })
            .then((response) => {
    ...
    async function submitReview(e) {
        ...
        axios.put(`${"http://localhost:5000"}/product/${id}/review`, reviewDetails, { withCredentials: true })
    ...
    async function updateReview(e) {
        ...
        axios.put(
            `${"http://localhost:5000"}/product/${id}/review/${user._id}`,
            reviewDetails,
    ...
    async function deleteReview() {
        axios.delete(`${"http://localhost:5000"}/product/${id}/review/${user._id}`, { withCredentials: true })
