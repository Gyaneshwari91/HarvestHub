...
export default function SignIn({ open, setOpen, status, setStatus, signInStatus, setSignInStatus, setTrigger }) {
    ...
    async function submitUser(e) {
        ...
        axios.post(`${"http://localhost:5000"}/user/login`, loginDetails, { withCredentials: true })
            .then(() => {
                setSignInStatus('typing');
    ...
    async function getOtp(e) {
        ...
        axios.post(`${"http://localhost:5000"}/password/forgot`, PassDetails, { withCredentials: true })
            .then(() => {
                setStatus('otp');
            })
    ...
    async function checkOtp(e) {
        ...
        axios.post(`${"http://localhost:5000"}/password/otpCheck`, PassDetails, { withCredentials: true })
            .then((response) => {
    ...
    async function submitPass(e) {
        ...
        axios.post(`${"http://localhost:5000"}/password/changePassword`, PassDetails, { withCredentials: true })
            .then(() => {
                setStatus('signIn')
            })
            .catch((error) => console.log(error));
