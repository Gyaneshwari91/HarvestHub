                ...
                <Container>
                    <Grid container columnSpacing={4} rowSpacing={8}>
                        <Grid item xs={12} sm={6} md={4}>
                            ...
                            <List>
                                <ListItem disablePadding> <ListItemText primary="Vishwakarma Institute of Technology, Pune" /> </ListItem>
                                <ListItem disablePadding> <ListItemText primary="Email: xyz@abc.in" /> </ListItem>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            ...
                            <Link component={RouterLink} to='https://www.linkedin.com'><LinkedInIcon fontSize="large" color="primary" /></Link>
                            <Link component={RouterLink} to='https://www.instagram.com'><InstagramIcon sx={{ ml: 1 }} fontSize="large" color="primary" /></Link>
                        ...
                        <Grid item xs={12}>
                            <Typography variant='subtitle2' align='center'>
                                2023 All Rights Reserved,Developed By HarvestHub
                            </Typography>
                        </Grid>
                    </Grid>
                </Container>
